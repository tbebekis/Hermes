...
/// <summary>
/// Represents the latest remote provider observation for a tracked item.
/// </summary>
public class RemoteObservedSnapshotRecord
{
    // ● properties
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the remote item exists.
    /// </summary>
    public bool ExistsFlag { get; set; }
    /// <summary>
    /// Gets or sets a value indicating whether the provider reported removal.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the provider mime type.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the provider change time.
    /// </summary>
    public DateTime? ProviderChangeTime { get; set; }
    /// <summary>
